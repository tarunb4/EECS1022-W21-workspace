 ...
 * This version improves version 1 by a calling a usable utility method.
 */
public class CircleApp2 {
	...
	public static void main(String[] args) {
		...
		// Step4: Output the result back to the user.
		...
		// Step1: Prompt the user for the radius of the 2nd circle.
